...
My predictions combine open data with a simplified version of [David Firth's approach](https://github.com/DavidFirth/alt3code). 

These predictions are based on a team's strength, given its performance in recent times. But how should we define *recent*? In order to duck this question, I choose two different time periods:
...
Finally, and with thanks to GitHub Actions, this page is updated daily in the season with the latest available data. At this point, that means games up to and including the day of:
